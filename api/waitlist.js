...
module.exports = async function handler(req, res) {
  ...
  try {
    ...
    if (!b.product_slug || !b.name || !b.email || !b.problem) {
      return json(res, 400, { error: "Product, name, email, and problem are required." });
    }
    await insert("product_waitlists", {
    ...
    return json(res, 200, { message: "You are on the research waitlist. Thank you for helping shape Vordali." });
  } catch (error) {
